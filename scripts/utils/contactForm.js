...
(function () {
  ...
  contactButton.addEventListener("click", function () {
    ...
    document.querySelectorAll(".stopFocus").forEach((element) => { // retirer le focus des elements en arriere plan
  ...
  document.querySelector(".closeModal").addEventListener("click", function () {
    document.querySelectorAll(".stopFocus").forEach((element) => { // remettre le focus des elements en arriere plan
